...
import { HiMail, HiOutlinePencil } from "react-icons/hi";
...
const DashboardDoctor = () => {
  ...
  const getDoctorInfo = () => {
    console.log("Called !");
    axios
      .get(`http://localhost:5000/user/doctor/info/${id}`)
      .then(({ data }) => {
        console.log(data);
  ...
  const getCompanyDetails = () => {
    axios
      .get(process.env.REACT_APP_SERVER_URL + `company/getcompanydetails/${id}`)
      .then(({ data }) => {
  ...
  useEffect(() => {
    ...
    if (Object.keys(formErrors).length === 0 && isSubmit) {
      axios
        .put(`http://localhost:5000/user/doctor/editprofile/${id}`, {
          ...editDetailsProfile,
        })
        .then(({ data }) => {
          if (data.message) {
    ...
    if (Object.keys(formErrors2).length === 0 && isSubmit2) {
      axios
        .put(process.env.REACT_APP_SERVER_URL + `company/editaccount/${id}`, {
          ...accountInfo,
        })
        .then(({ data }) => {
          if (data.message) {
  ...
  const name_initials =
    typeof initials === "string" ? initials.split("")[0] : "";

  const setEditProfile = () => {
    setIsModal(!isModal);
    setCompanyInfo({
      ...companyInfo,
      linkedinlink: companyInfoDetails.linkedin,
      websitelink: companyInfoDetails.websitelink,
      ...
      {isPageLoading ? (
        ...
        <div className="main_container_dashboardDoctor">
          <div className="left_section_container_dashboardDoctor">
            <div className="top_details_section_dashboardDoctor">
              <div className="left_details_section_dashboardDoctor">
                ...
                <HiOutlinePencil
                  ...
                  className="edit_icon2_dashboardDoctor"
                />
              </div>
              ...
              <div className="right_details_section_dashboardDoctor">
                <HiOutlinePencil
                  onClick={setEditProfile}
                  className="edit_icon_dashboardDoctor"
                  data-tip
                ...
                <button className="btn_primary_profile_dashboardDoctor">
                  View Profile
                </button>
              </div>
            </div>
            ...
            <div className="mid_details_section_dashboardDoctor">
              <div className="account_container_dashboardDoctor">
                ...
                <div className="bottom_box_account_dashboardDoctor">
                  <p>
                    Change your name, location, company type, etc. from here.
                  </p>
                </div>
              </div>
              ...
              <div className="applicants_container_dashboardDoctor">
                ...
                <div className="bottom_box_applicants_dashboardDoctor">
                  <p>
                    Check new applicants applied for your internship
                    post.&nbsp;&nbsp;&nbsp;&nbsp;
                  </p>
                </div>
              </div>
            ...
            <div className="mid2_details_section_dashboardDoctor">
              <div className="messages_container_dashboardDoctor">
                <div className="messages_top_section_dashboardDoctor">
                  <h2>Messages</h2>
                </div>

                <div className="messages_middle_section_dashboardDoctor">
                  <div className="message_middle_left_section_dashboardDoctor">
                    <h3>25</h3>
                  </div>
                  <div className="message_middle_right_section_dashboardDoctor">
                    <HiMail className="message_mail_icon_dashboardDoctor" />
                    <p>New</p>
                  </div>
                </div>

                <div className="messages_bottom_section_dashboardDoctor">
                  <div className="message_box_dashboardDoctor">
                    <div className="message_box_left_section_dashboardDoctor">
                      <p>S</p>
                    </div>

                    <div className="message_box_right_section_dashboardDoctor">
                      <h4>Sunil Joshi</h4>
                      <div>
                        <h3>
                          Lorem ipsum dolor sit amet consectetur adipisicing
                          elit. Voluptatem labore optio delectus non tenetur
                          minima aliquid aspernatur nihil a soluta inventore
                          assumenda laudantium, repudiandae ipsam error velit,
                          recusandae ad commodi?
                        </h3>
                      </div>
                      <p>18/09/2023 20:23 AM</p>
                    </div>
                  </div>
              ...
              <div className="notifications_container_dashboardDoctor">
                <div className="notifications_top_section_dashboardDoctor">
                  <h2>Notifications</h2>
                </div>

                <div className="notifications_bottom_section_dashboardDoctor">
                  <div className="notification_box_dashboardDoctor">
                    <div className="notification_box_left_section_dashboardDoctor">
                      <p>Dr.</p>
                    </div>

                    <div className="notification_box_right_section_dashboardDoctor">
                      <h3>Dr sultads Send you Photo</h3>
                      <p>Just Now</p>
                    </div>
                  </div>
          ...
          <div className="right_section_container_dashboardDoctor">
            <div className="top_tc_section_dashboardDoctor">
              ...
              <p>
                If you handle any patient from Maatri, it is mandatory to Send
                Offer from the platform. If you do not do so, we may take some
                action and you won't be allowed to use our services further.
              </p>
            </div>
          </div>
        </div>
              ...
              <form>
                <div className="form_box_dashboardDoctor">
                  ...
                  <input
                    ...
                    defaultValue={companyInfoDetails.linkedin}
                    onChange={handleForm}
                  />
                  <p className="errors_msg_dashboardDoctor">
                ...
                <div className="form_box_dashboardDoctor">
                  ...
                  <input
                    type="url"
                    name="websitelink"
                    defaultValue={companyInfoDetails.websitelink}
                ...
                <div className="form_box_dashboardDoctor">
                  ...
                  <select
                    ...
                    className="select_dashboardDoctor"
                  >
                    <option value="" disabled selected hidden>
                      {companyInfoDetails.headquaters}
                    </option>
                ...
                <div className="form_box_dashboardDoctor">
                  ...
                  >
                    <option value="" disabled selected hidden>
                      {companyInfoDetails.typeofcompany}
                    </option>
                    {typeData.map((val) => (
                      <option key={val} value={val}>
                        {val}
                ...
                <div className="form_box_dashboardDoctor">
                  ...
                  <input
                    ...
                    value={companyInfoDetails.established}
                  />
                </div>
                ...
                <div className="form_box_dashboardDoctor">
                  ...
                  <textarea
                    ...
                    name="about"
                    onChange={handleForm}
                    defaultValue={companyInfoDetails.description}
                    placeholder="Explain what your company does..."
                  ></textarea>
                  <p className="errors_msg_dashboardDoctor">
                    {formErrors.about}
                  </p>
                ...
                <div className="modal_bottom_section_dashboardDoctor">
                  <button
                    onClick={closeForm}
                    className="btn_light_dashboardDoctor"
                  >
                    Cancel
                  </button>
                  <button
                    type="submit"
                    onClick={submitForm}
                    className="btn_primary_dashboardDoctor"
                  >
                    Save Details
                  </button>
                </div>
              ...
              <form>
                ...
                <div className="form_box_dashboardDoctor">
                  ...
                  <input
                    type="text"
                    name="companyname"
                    defaultValue={doctordetails.companyname}
                    placeholder="Enter Company Name"
                    onChange={handleForm2}
                  />
                  <p className="errors_msg_dashboardDoctor">
                    {formErrors2.companyname}
                  </p>
                </div>
                ...
                <div className="form_box_dashboardDoctor">
                  ...
                  <input
                    type="number"
                    defaultValue={doctordetails.phoneno}
                    name="mobile"
